...
<div align="center">
    A free RESTful API serving anime information from <a href="https://aniwatchtv.to" target="_blank">aniwatchtv.to</a>
...
> 2. This API is just an unofficial API for [aniwatchtv.to](https://aniwatchtv.to) and is in no other way officially related to the same.
